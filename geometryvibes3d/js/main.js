const GAME_URL =
  "https://files.twoplayergames.org/files/games/g1/geometry-vibes-3d-v11/index.html";
...
const voteKey = "geometryvibes3d-vote";
...
async function sharePage() {
  const siteUrl = (window.GEOMETRYVIBES3D_CONFIG && window.GEOMETRYVIBES3D_CONFIG.siteUrl) || window.location.origin;
  const payload = {
    title: "Geometry Vibes 3D",
    text: "Play Geometry Vibes 3D in your browser.",
    url: siteUrl.replace(/\/$/, "") + "/",
  };
