...
const voteKey = "geometryvibes-vote";
...
async function sharePage() {
  const siteUrl = (window.GEOMETRYVIBES_CONFIG && window.GEOMETRYVIBES_CONFIG.siteUrl) || window.location.origin;
  const payload = {
    title: "Geometry Vibes",
    text: "Play Geometry Vibes in your browser.",
    url: siteUrl.replace(/\/$/, "") + "/",
  };
